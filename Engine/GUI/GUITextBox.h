...
{
public:
	GUITextBox(glm::vec2 position, glm::vec2 relativeTo, glm::vec2 size, GLFWwindow* window,Input* input,Font* font, glm::vec3 dColour, glm::vec3 sColour, std::string acceptedCharacters);
	~GUITextBox();
